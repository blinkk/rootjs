...
import {IconBold, IconItalic, IconLink, IconStrikethrough, IconSuperscript, IconUnderline} from '@tabler/icons-preact';
...
function FloatingToolbar(props: FloatingToolbarProps) {
  ...
  return (
    <div ref={popupCharStylesEditorRef} className="LexicalEditor__floatingToolbar">
      {editor.isEditable() && (
        <>
          <ToolbarActionIcon
            variant="hover"
